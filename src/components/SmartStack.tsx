    ...
    return (
        <div className="flex flex-col gap-6 w-full h-full">
            ...
            >
                ...
                {/* Decor */}
                <div className="absolute -bottom-10 -right-10 w-32 h-32 bg-theme/30 blur-3xl rounded-full" />
            </motion.div>
            ...
            >
                ...
                <div className="flex items-center gap-4 p-3 bg-white/40 rounded-xl border border-white/20">
                    <div className="w-1 h-10 bg-theme rounded-full shadow-[0_0_10px_var(--color-theme)]" />
                    <div className="flex flex-col">
                ...
                <div className="flex items-center gap-4 p-3 bg-white/40 rounded-xl border border-white/20">
                    <div className="w-1 h-10 bg-theme/60 rounded-full" />
                    <div className="flex flex-col">
